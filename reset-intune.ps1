#####################################################################
# Part of this borrowed from other contributors - I tried digging in my OneNote to find them but turned up short ;(
# Kindly contact me to take credit!!
#####################################################################
...
# This one popped up in some troubleshooting so we'll remove it to avoid the headache!
